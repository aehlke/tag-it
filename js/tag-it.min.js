...
b(a).children("input").val()},_showAutocomplete:function(){this.tagInput.autocomplete("search","")},_existingTag:function(a){var d=this,c=null;this._tags().each(function(){if(d._formatStr(a)==d._formatStr(d.tagLabel(this)))return c=b(this),!1});return c},_isNew:function(a){return!this._existingTag(a)},_formatStr:function(a){return this.options.caseSensitive?a:b.trim(a.toLowerCase())},createTag:function(a,d,c){var e=this,a=b.trim(a);if(""===a)return!1;if(!this.allowDuplicates&&!this._isNew(a))return this._trigger("onTagExists",
